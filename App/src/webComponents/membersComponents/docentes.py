                            ...
                            content=ft.Row(
                                [
                                    ft.Column(
                                        [
                                            ft.ListTile(
                                                title=ft.TextField(content['name'], on_change=lambda e: self.changeData(e, column='name'), label="Nome do Docente"),
                                                width=600, 
                                                ),
                                            ft.ListTile(
                                    ...
                                    ft.Column(
                                        [
                                            ...
                                            ft.ListTile(
                                                title=ft.TextField(content['posicao'], on_change=lambda e: self.changeData(e, column='posicao'), label="Posiçao na Universidade"),
                                                width=600, 
                                                ),
                                            ft.ListTile(
