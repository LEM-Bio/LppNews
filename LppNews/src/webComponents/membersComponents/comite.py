                            ...
                            content=ft.Row(
                                [
                                    ft.Column(
                                        [
                                            ft.ListTile(
                                                title=ft.TextField(content['name'], on_blur=lambda e: self.changeData(e, column='name', content=content), label="Nome do Tecnico"),
                                                width=600, 
                                                ),
                                            ft.ListTile(
                                                title=ft.TextField(content['posicao'], on_blur=lambda e: self.changeData(e, column='posicao', content=content), label="Posicao"),
                                                width=600, 
                                                ),
                                        ],
