                            ...
                            content=ft.Row(
                                [
                                    ft.Column(
                                        [
                                            ft.ListTile(
                                                title=ft.TextField(content['name'], on_blur=lambda e: self.changeData(e, column='name', content=content), label="Nome do Coordenador"),
                                                width=600, 
                                                ),
                                            ft.ListTile(
                                                title=ft.TextField(content['posicaoLab'], on_blur=lambda e: self.changeData(e, column='posicaoLab', content=content), label="Posiçao no laboratorio"),
                                                width=600, 
                                                ),
                                            ft.ListTile(
                                                title=ft.TextField(content['dep'], on_blur=lambda e: self.changeData(e, column='dep', content=content), label="Departamento"),
                                                width=600, 
                                                ),
                                        ],
                                    ...
                                    ft.Column(
                                        [
                                            ...
                                            ft.ListTile(
                                                title=ft.TextField(content['posicaoUni'], on_blur=lambda e: self.changeData(e, column='posicaoUni', content=content), label="Posiçao na Universidade"),
                                                width=600, 
                                                ),
                                            ft.ListTile(
